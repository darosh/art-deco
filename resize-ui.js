...
// post('resize.js version: ' + VERSION + '\n')
    ...
    if (dx2 || dy2) {
      ...
      if (do_constrain == 1) {
        ...
        if (constraintargets_arr == null || constraintargets_arr_incl('box')) {
          // post('box ' + JSON.stringify(Object.keys(box)) + '\n')
          // post('box rect ' + JSON.stringify(box.rect) + '\n')
      ...
      for (var i = 1; i < jsarguments.length; i++) {
        ...
        // post('Object position: ' + obj_pos.join(', ') + '\n')
